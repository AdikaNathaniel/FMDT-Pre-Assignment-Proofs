// Imports the 'dart:io' library, which provides functionality for input/output
// operations, like reading from the console.
import 'dart:io';
void main() {
// Prompts the user to enter their name.
print('Please enter your name:');
// Reads a line of input from the console.
// stdin.readLineSync() returns a nullable String (String?) because the user might
// not enter anything.
